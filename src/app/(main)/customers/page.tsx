...
//   return (
//     <div className="flex items-center justify-center min-h-screen min-w-screen ms-80 border">
...
export default function Profile() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen"> {/* Adjusted styling here */}
      {error && <p className="text-red-500">{error}</p>}
      {filteredCustomers.length === 0 ? (
