...
//     //   unique = !accounts.some(account => account.accountNumber === newAccountNumber);
//     unique = !accounts.some((account: any) => {
//         console.log('Account:', account); 
//         return account.accountNumber === newAccountNumber;
//       });
//     }
...
//         <p>Checking:</p>
//         <OptionButton checked={isChecked} onChange={handleOptionButtonChange} />
//       </div>
